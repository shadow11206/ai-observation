...
- [ ] Qwen3.5-Omni 的 OmniGAIA 差距（-11.7分）是否会随权重开源 + 工程师微调而缩小？预计 6 个月内可验证
- [ ] 权重是否会开源？若开源时间线超过 1 年，说明阿里已战略放弃开源生态，转向纯 API 商业化
- [ ] OpenRouter 上 Qwen Omni 系列的调用量增长趋势，是否可以验证「内容处理轨道」的市场渗透
